...
function AnalyticsPage() {
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "AnalyticsPage.useEffect": ()=>{
            ...
            if (period === 'daily') {
                ...
                for(let i_0 = 11; i_0 >= 0; i_0--){
                    const end = new Date(now);
                    end.setDate(now.getDate() - i_0 * 7);
                ...
                for(let i_1 = 11; i_1 >= 0; i_1--){
                    const d_0 = new Date(now.getFullYear(), now.getMonth() - i_1, 1);
                    ranges.push({
                        start: new Date(d_0.getFullYear(), d_0.getMonth(), 1, 0, 0, 0, 0),
                        end: new Date(d_0.getFullYear(), d_0.getMonth() + 1, 0, 23, 59, 59, 999),
                        day: months[d_0.getMonth()],
                        month: String(d_0.getFullYear()),
                        fullLabel: `${months[d_0.getMonth()]} ${d_0.getFullYear()}`
                    });
                }
            } else {
                for(let i_2 = 4; i_2 >= 0; i_2--){
                    const year = now.getFullYear() - i_2;
                    ranges.push({
    ...
    async function loadAnalytics() {
        ...
        try {
            ...
            const count = orders.filter((o_0)=>o_0.status !== 'cancelled').length;
            // Payment methods breakdown
            const cashOrders = orders.filter((o_1)=>[
                    'cash',
                    'CASH'
                ].includes(o_1.payment_method));
            const qrisOrders = orders.filter((o_2)=>[
                    'qris',
                    'QRIS'
                ].includes(o_2.payment_method));
            const transferOrders = orders.filter((o_3)=>[
                    'transfer',
                    'TRANSFER',
                    'bank_transfer',
                    'BANK_TRANSFER'
                ].includes(o_3.payment_method));
            const cash = cashOrders.reduce((s, o_4)=>o_4.status === 'cancelled' ? s - (o_4.total || 0) : s + (o_4.total || 0), 0);
            const qris = qrisOrders.reduce((s_0, o_5)=>o_5.status === 'cancelled' ? s_0 - (o_5.total || 0) : s_0 + (o_5.total || 0), 0);
            const transfer = transferOrders.reduce((s_1, o_6)=>o_6.status === 'cancelled' ? s_1 - (o_6.total || 0) : s_1 + (o_6.total || 0), 0);
            // Top selling items
            const itemMap = new Map();
            orders.filter((order)=>order.status !== 'cancelled').forEach((order_0)=>{
                order_0.order_items?.forEach((item)=>{
            ...
            orders.filter((o_7)=>o_7.status !== 'cancelled').forEach((order_1)=>{
                if (order_1.table_number) {
                    const existing_0 = tableMap.get(order_1.table_number) || {
                        orders: 0,
                        revenue: 0,
                        customers: 0
                    };
                    tableMap.set(order_1.table_number, {
                        orders: existing_0.orders + 1,
                        revenue: existing_0.revenue + (order_1.total || 0),
                        customers: existing_0.customers + 1
                    });
                }
            });
            const tables = Array.from(tableMap.entries()).map(([tableNumber, data_0])=>({
                    tableNumber,
                    orders: data_0.orders,
                    revenue: data_0.revenue,
                    avgOrder: data_0.orders > 0 ? data_0.revenue / data_0.orders : 0,
                    customers: data_0.customers
                })).sort((a_0, b_0)=>b_0.revenue - a_0.revenue);
            // Peak hour
            const hourMap = new Map();
            orders.forEach((order_2)=>{
                if (order_2.paid_at) {
                    const hour = new Date(order_2.paid_at).getHours();
                    hourMap.set(hour, (hourMap.get(hour) || 0) + 1);
                }
            });
            const peakHourData = Array.from(hourMap.entries()).sort((a_1, b_1)=>b_1[1] - a_1[1])[0];
    ...
    function handleRestaurantChange(restaurantId) {
        const selected_0 = allRestaurants.find((r_0)=>r_0.id === restaurantId);
        if (selected_0) {
            setRestaurant(selected_0);
                    ...
                    children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            allRestaurants.length > 1 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                ...
                                children: allRestaurants.map((r_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                        value: r_1.id,
                                        children: r_1.name
                                    }, r_1.id, false, {
                                        fileName: "[project]/src/app/dashboard/analytics/page.tsx",
                        ...
                        children: [
                            ...
                            topItems.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: topItems.slice(0, 4).map((item_0, idx_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    ...
                                                    children: [
                                                        ...
                                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                            ...
                                                            children: formatCurrency(item_0.revenue)
                                                        }, void 0, false, {
                                                            fileName: "[project]/src/app/dashboard/analytics/page.tsx",
                                                            lineNumber: 433,
                                                            columnNumber: 25
                            ...
                            tableAnalytics.length > 0 && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                ...
                                children: [
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "grid grid-cols-1 md:grid-cols-2 gap-4",
                                        children: tableAnalytics.slice(0, 4).map((table, idx_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                className: "p-4 bg-gray-50 rounded-xl",
                                                children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                    className: "flex items-start justify-between mb-2",
                                                    children: [
...
_s(AnalyticsPage, "ODqvfCEXOt1pJSTxDt9U8hwsqJA=", false, function() {
    return [
...
//# sourceMappingURL=_5c6c433c._.js.map