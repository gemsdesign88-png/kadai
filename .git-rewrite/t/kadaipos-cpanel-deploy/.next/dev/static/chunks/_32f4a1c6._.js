...
function MenuPage() {
            ...
            if (items) {
                ...
                const enrichedItems = items.map((item)=>{
                    if (item.category_id) {
                        ...
                        if (categoryInfo) {
                            const parent = categoryInfo.parent_id ? allCategories.find((c_0)=>c_0.id === categoryInfo.parent_id) : null;
                            return {
                                ...item,
                                menu_category: {
                                    ...categoryInfo,
    ...
    async function fetchCategories(restaurantId) {
        try {
            const { data, error: error_1 } = await supabase.from('menu_categories').select('*').eq('restaurant_id', restaurantId).order('name');
            if (error_1) {
            ...
            const parents = cats.filter((c_1)=>!c_1.parent_id);
    ...
    function filterItems() {
        ...
        if (selectedParentCategory !== 'all') {
            filtered = filtered.filter((item_0)=>{
                if (item_0.menu_category) {
                    // Check if item's category or its parent matches
                    return item_0.menu_category.id === selectedParentCategory || item_0.menu_category.parent_id === selectedParentCategory;
                }
                return false;
            });
        }
        ...
        if (selectedSubCategory !== 'all') {
            filtered = filtered.filter((item_1)=>item_1.category_id === selectedSubCategory);
        }
        // Search filter
        if (searchTerm) {
            filtered = filtered.filter((item_2)=>item_2.name?.toLowerCase().includes(searchTerm.toLowerCase()) || item_2.description?.toLowerCase().includes(searchTerm.toLowerCase()));
        }
        setFilteredItems(filtered);
    }
    function getSubcategories(parentId) {
        return allCategories.filter((c_2)=>c_2.parent_id === parentId);
    }
    ...
    function openModal(item_3 = null) {
        if (item_3) {
            setEditingItem(item_3);
            setFormData({
                name: item_3.name || '',
                description: item_3.description || '',
                price: item_3.price?.toString() || '',
                category: item_3.category || '',
                category_id: item_3.category_id || null,
                stock: item_3.stock?.toString() || '',
                image_url: item_3.image_url || '',
                available: item_3.available ?? true
            });
        } else {
            setEditingItem(null);
            setFormData({
    ...
    async function handleSubmit(e) {
        ...
        if (formData.category_id) {
            const selectedCat = allCategories.find((c_3)=>c_3.id === formData.category_id);
            if (selectedCat) {
        ...
        try {
            ...
            console.error('Error saving menu item:', error_2);
        }
    }
    async function handleCreateCategory(e_0) {
        e_0.preventDefault();
        if (!restaurant || !newCategoryName.trim()) return;
        try {
            const { error: error_4 } = await supabase.from('menu_categories').insert({
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: filteredItems.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 318,
                            columnNumber: 41
                        }, this) : filteredItems.map((item_4)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: "bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-md transition-shadow",
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        className: "aspect-video bg-gray-100 flex items-center justify-center",
                                        children: item_4.image_url ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("img", {
                                            src: item_4.image_url,
                                            alt: item_4.name,
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                ...
                                                children: item_4.description || 'Tidak ada deskripsi'
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/menu/page.tsx",
                                                lineNumber: 333,
                                                columnNumber: 19
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                                ...
                                                children: [
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
                                                        className: "text-2xl font-bold text-gray-900",
                                                        children: formatCurrency(item_4.price)
                                                    }, void 0, false, {
                                                        fileName: "[project]/src/app/dashboard/menu/page.tsx",
                                                        lineNumber: 337,
                                                        columnNumber: 21
                                                    ...
                                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                        className: `text-sm font-medium ${item_4.stock > 10 ? 'text-green-600' : item_4.stock > 0 ? 'text-yellow-600' : 'text-red-600'}`,
                                                        children: [
                                                            "Stok: ",
                                                            item_4.stock
                                                        ]
                                    ...
                                    children: [
                                        ...
                                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("select", {
                                            ...
                                            children: [
                                                ...
                                                categories.map((cat_0)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("option", {
                                                        value: cat_0,
                                                        children: cat_0
                                                    }, cat_0, false, {
                                                        fileName: "[project]/src/app/dashboard/menu/page.tsx",
...
_s(MenuPage, "9JI1DSNHRHwMjKziY2NjJVFIk0U=", false, function() {
    return [
...
//# sourceMappingURL=_32f4a1c6._.js.map