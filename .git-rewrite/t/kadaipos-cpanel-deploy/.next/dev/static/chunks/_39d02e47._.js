...
function TablesPage() {
    ...
    async function handleSubmit(e) {
        ...
        try {
            ...
            console.error('Error saving table:', error_0);
        }
    }
    async function deleteTable(id) {
        ...
        try {
            ...
            console.error('Error deleting table:', error_1);
        }
    }
    async function updateTableStatus(id_0, status) {
        try {
            ...
            console.error('Error updating table status:', error_2);
        }
    }
    function showQRCode(table_0) {
        setSelectedQRTable(table_0);
        setShowQRModal(true);
    }
    ...
    const occupiedTables = tables.filter((t_0)=>t_0.status === 'occupied').length;
    if (loading) {
                ...
                children: [
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: tables.length === 0 ? /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            lineNumber: 188,
                            columnNumber: 34
                        }, this) : tables.map((table_1)=>/*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                className: `bg-white rounded-2xl p-6 border-2 ${getStatusColor(table_1.status)} shadow-sm hover:shadow-md transition-all`,
                                children: [
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                                className: `inline-block px-3 py-1 rounded-full text-xs font-semibold ${getStatusColor(table_1.status)}`,
                                                children: getStatusText(table_1.status)
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/tables/page.tsx",
                                                lineNumber: 199,
                                                columnNumber: 19
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>updateTableStatus(table_1.id, 'available'),
                                                className: `p-2 text-xs rounded ${table_1.status === 'available' ? 'bg-green-500 text-white' : 'bg-gray-100 text-gray-600'}`,
                                                title: "Tersedia",
                                                children: "✓"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/tables/page.tsx",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>updateTableStatus(table_1.id, 'occupied'),
                                                className: `p-2 text-xs rounded ${table_1.status === 'occupied' ? 'bg-red-500 text-white' : 'bg-gray-100 text-gray-600'}`,
                                                title: "Terisi",
                                                children: "●"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/tables/page.tsx",
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>updateTableStatus(table_1.id, 'reserved'),
                                                className: `p-2 text-xs rounded ${table_1.status === 'reserved' ? 'bg-yellow-500 text-white' : 'bg-gray-100 text-gray-600'}`,
                                                title: "Dipesan",
                                                children: "◐"
                                            }, void 0, false, {
                                                fileName: "[project]/src/app/dashboard/tables/page.tsx",
                                    ...
                                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                                        ...
                                        children: [
                                            ...
                                            /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                                                onClick: ()=>deleteTable(table_1.id),
...
_s(TablesPage, "Z/gmMeR505gvX5iGr6ztLwSFSMA=", false, function() {
    return [
...
//# sourceMappingURL=_39d02e47._.js.map