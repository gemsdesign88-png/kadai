        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <div className="text-right">
              <p className="text-sm font-semibold text-gray-600">{activeRestaurant?.name}</p>
                      ...
                      <ResponsiveContainer width="100%" height="100%">
                        <ComposedChart data={customerRevenueData}>
                          ...
                          <YAxis 
                            ...
                            stroke="#6b7280"
                            style={{ fontSize: '12px' }}
                            label={{ value: language === 'en' ? 'Orders' : 'Pesanan', angle: -90, position: 'insideLeft' }}
                          />
                          <YAxis 
                            yAxisId="right"
                            orientation="right"
                            ...
                            label={{ value: language === 'en' ? 'AOV' : 'AOV', angle: 90, position: 'insideRight' }}
                          />
                          <Tooltip 
                            contentStyle={{ backgroundColor: '#fff', border: '1px solid #e5e7eb', borderRadius: '8px' }}
                            formatter={(value: any) => {
