...
export default function PaymentFeaturePage() {
  ...
  const paymentMockups = [
    PaymentCheckoutMockup, SplitBillMockup, QRISPaymentMockup, ReceiptMockup
  ]
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <div className="inline-flex items-center gap-2 px-4 py-2 bg-pink-100 rounded-full mb-6">
                ...
                <span className="text-sm font-bold text-pink-700">{t.featurePages.payment.badge}</span>
              </div>
              
              <h1 className="text-5xl md:text-6xl font-black text-gray-900 mb-6">
                {t.featurePages.payment.title}
              </h1>
              
              <p className="text-xl text-gray-600 leading-relaxed mb-8">
                {t.featurePages.payment.description}
              </p>
            ...
            >
              ...
              <div className="relative p-8">
                <MockupCarousel mockups={paymentMockups} color="#EC4899" language={language} />
              </div>
            </motion.div>
          </div>
        </Container>
      ...
      <section className="py-20">
        <Container>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            {t.featurePages.payment.features.map((feature, i) => (
              <motion.div
                key={i}
