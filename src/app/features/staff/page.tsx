              ...
              <div className="relative p-8">
                <div className="bg-white rounded-2xl p-6 shadow-2xl">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    <span className="px-3 py-1 bg-amber-100 text-amber-700 rounded-full text-sm font-bold">8 active</span>
                  </div>
                  {[{name: "Budi", role: "Kasir"}, {name: "Siti", role: "Waiter"}, {name: "Joko", role: "Chef"}].map((staff, i) => (
                    <div key={i} className="mb-3 p-4 bg-amber-50 rounded-xl">
