              ...
              <div className="relative p-8">
                <div className="bg-white rounded-2xl p-6 shadow-2xl">
                  <div className="text-center mb-4">
                    <h3 className="font-bold text-gray-900 mb-2">Scan to Order</h3>
                    <div className="w-32 h-32 mx-auto bg-gradient-to-br from-cyan-200 to-blue-200 rounded-xl flex items-center justify-center">
                      <div className="text-4xl">QR</div>
                    </div>
                  </div>
                  <div className="space-y-2">
                    {["Nasi Goreng Spesial", "Mie Ayam Bakso", "Es Teh Manis"].map((item, i) => (
                      <div key={i} className="p-3 bg-cyan-50 rounded-lg flex items-center justify-between">
                        <div className="flex items-center gap-2">
                          <div className="w-10 h-10 bg-cyan-200 rounded"></div>
