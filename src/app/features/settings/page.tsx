                ...
                <div className="bg-white rounded-2xl p-6 shadow-2xl">
                  ...
                  <div className="space-y-3">
                    {[
                      ...
                      {label: "Tax Configuration", icon: "💰"},
                      {label: "Receipt Settings", icon: "🧾"},
                      {label: "Notifications", icon: "🔔"},
                      {label: "User Permissions", icon: "👥"},
                      {label: "Language", icon: "🌐"}
                    ].map((setting, i) => (
                      <div key={i} className="p-3 bg-indigo-50 rounded-xl flex items-center justify-between hover:bg-indigo-100 transition-colors cursor-pointer">
