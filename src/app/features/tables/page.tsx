            ...
            >
              ...
              <div className="relative p-8">
                <div className="bg-white rounded-2xl p-6 shadow-2xl">
                  <h3 className="font-bold text-gray-900 mb-4">Floor Plan</h3>
                  <div className="grid grid-cols-3 gap-3">
                    {[1,2,3,4,5,6,7,8,9].map((table) => {
                      ...
                      return (
                        <div key={table} className={`aspect-square ${bgColor} border-2 rounded-xl flex items-center justify-center`}>
                          <div className="text-center">
                            <div className="font-bold text-gray-900">{table}</div>
                            <div className="text-xs text-gray-600">{status === 'occupied' ? '2/4' : ''}</div>
                          </div>
                        </div>
                      );
                    })}
