...
export default function OwnerClient() {
  ...
  const getExpiryStatus = (restaurant: Restaurant) => {
    ...
    return {
      date: new Date(expiryDate).toLocaleDateString(locale, { 
        day: 'numeric', 
        month: 'long', 
        year: 'numeric' 
      }),
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8">
      ...
      <div className="bg-white rounded-2xl border-2 border-gray-200 shadow-sm mb-8 overflow-hidden">
        ...
        <div className="px-8 pb-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 mb-4">{profile?.full_name || dt('owner')}</h2>
      ...
      <div className="mb-6 flex items-center justify-between">
        ...
        <button
          onClick={() => router.push('/dashboard/owner/restaurant/new')}
        ...
        {restaurants.map((restaurant) => {
          ...
          return (
            ...
            >
              ...
              {/* Action Button */}
              <button
                onClick={() => router.push(`/dashboard/subscription?restaurant=${restaurant.id}`)}
