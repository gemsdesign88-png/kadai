  ...
  const plans = [
    {
      ...
      name: dt('monthlyPlan'),
      price: 'Rp 149.000',
      period: language === 'en' ? '/month' : language === 'zh' ? '/月' : '/bulan',
    ...
    },
    {
      ...
      name: dt('yearlyPlan'),
      price: 'Rp 1.599.000',
      period: language === 'en' ? '/year' : language === 'zh' ? '/年' : '/tahun',
      duration: dt('perOutlet'),
      icon: '⭐',
      badge: dt('save11'),
      popular: true,
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {restaurants.map((restaurant) => {
              ...
              const expiryDate = restaurant.subscription_ends_at 
                ? new Date(restaurant.subscription_ends_at).toLocaleDateString(locale, { 
                    day: 'numeric', 
                    month: 'long', 
                    year: 'numeric' 
                  })
                : restaurant.trial_ends_at
                ? new Date(restaurant.trial_ends_at).toLocaleDateString(locale, { 
                    day: 'numeric', 
                    month: 'long', 
                    year: 'numeric' 
                  })
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {plans.map((plan) => (
              ...
              >
                ...
                <p className="text-sm text-gray-500 mb-6">{language === 'en' ? 'Valid for' : language === 'zh' ? '适用于' : 'Berlaku untuk'} {plan.duration}</p>
