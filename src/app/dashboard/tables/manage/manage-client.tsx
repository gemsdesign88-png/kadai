          ...
          <div className="bg-white rounded-2xl p-6 max-w-md w-full">
            ...
            <div className="bg-gray-50 p-4 rounded-xl mb-6">
              <div className="bg-white p-4 rounded-lg shadow-sm mx-auto w-fit">
                <img 
                  src={`https://api.qrserver.com/v1/create-qr-code/?size=200x200&data=${encodeURIComponent(`https://order.kadai.id/${restaurant?.name?.toLowerCase().replace(/\s+/g, '-')}/${selectedQRTable.barcode || selectedQRTable.id}`)}&v=2`}
                  alt="QR Code"
                  className="w-52 h-52"
                />
              </div>
