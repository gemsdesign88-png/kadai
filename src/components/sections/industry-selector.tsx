    ...
    <section className="relative py-20 md:py-32 bg-white overflow-hidden">
      ...
      <Container>
        ...
        >
          ...
          <Link
            href="/contact"
            className="inline-flex items-center gap-2 px-8 py-4 bg-white/10 hover:bg-white/20 border border-white/20 hover:border-white/30 text-white rounded-full font-semibold backdrop-blur-xl transition-all hover:scale-105"
          >
            {t.nav.contact}
            <ArrowRight className="w-4 h-4" />
          </Link>
