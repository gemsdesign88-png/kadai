  ...
  en: {
    nav: {
      ...
      businessMenu: {
        ...
        subtitle: "Perfect POS system for every business type",
        tokoTitle: "Kadai Toko",
        tokoDesc: "Simple POS for Small Businesses",
        restoTitle: "Kadai Resto",
        restoDesc: "Complete Restaurant Management",
        compare: "Compare Both Solutions"
      },
    },
    hero: {
      ...
      subtitle: "Kadai is the all-in-one point of sale solution for restaurants, cafes, and retail stores. Increase efficiency, delight customers, and grow your business.",
      getStarted: "Get Started",
      watchDemo: "Watch Demo",
      badge: "The Best POS System",
      heading: "Excellence. Built in.",
      tagline: "The most powerful POS system designed end-to-end for restaurant and store owner. Fast, intuitive, and built for growth.",
    ...
    cta: {
      ...
      futureOfRestaurant: "Experience the future of restaurant management with Kadai",
    ...
    contact: {
      badge: "CONTACT FORM COMING SOON",
      title: "Get in",
      titleHighlight: "Touch",
      subtitle: "We're building a beautiful contact form for you. Meanwhile, reach out to us directly via WhatsApp, email, or phone!",
      whatsappPlaceholder: "WhatsApp number (e.g., 628123456789)",
      contactMe: "Contact Me",
      registered: "Registered!",
      successMessage: "✓ We'll contact you via WhatsApp soon!",
      contactMethods: {
        whatsapp: {
          title: "WhatsApp",
    ...
    about: {
      ...
      subtitle: "Kadai is a new, modern point of sale system designed for all types of Indonesian businesses - from restaurants and cafes to retail stores. We're building a powerful yet intuitive platform to help business owners manage their operations efficiently and focus on what matters most - serving their customers.",
      stats: {
        founded: "Founded",
    ...
    pricing: {
      ...
      completeSolution: "Complete POS solution for modern businesses",
      tokoTagline: "Simple POS for retail & shops",
      tokoSuitable: "Retail, Boutiques, Mini-markets",
      restoTagline: "Complete management for cafes & restaurants",
      restoSuitable: "Cafes, Restaurants, Bars, Bakeries",
      heroTitle: "Choose the Perfect",
      heroTitleHighlight: "Solution for Your Business",
      heroOr: "or",
      heroToko: "Kadai Toko",
      ...
      tiersNote: "Revenue is calculated based on total monthly transactions processed through KadaiPOS.",
      ...
      comparisonBox: "Compare Kadai Toko vs Kadai Resto",
    ...
    privacy: {
      ...
      importantNotice: {
        ...
        content: "Please read this Privacy Policy carefully. By using KadaiPOS, you acknowledge that you have read, understood, and agree to be bound by this policy. If you do not agree, please do not use our services."
      },
      privacyCommitment: {
      ...
      sections: {
        intro: {
          ...
          content: "Welcome to Kadai Privacy Policy. This policy explains how we collect, use, protect, and share your personal information when you use our Point of Sale system for restaurant management. We are committed to protecting your privacy and ensuring the security of your data. By using Kadai, you agree to the collection and use of information in accordance with this policy."
        },
        collection: {
          title: "2. Information We Collect",
          content: "2.1 Personal Information: Name, email address, phone number, user role and permissions, account credentials (encrypted), staff ID and employment information. 2.2 Transaction Data: Order details and timestamps, payment information and methods, customer preferences and history, table and service information. 2.3 Usage Data: System activity logs, feature usage patterns, device information (type, OS, browser), IP address and location data. 2.4 Restaurant Data: Menu items and pricing, inventory levels, business hours and settings, custom branding and themes."
        },
        usage: {
          title: "3. How We Use Your Information",
          content: "3.1 Service Provision: Process and manage restaurant operations, provide POS system functionality, generate reports and analytics, support customer service requests. 3.2 System Improvement: Analyze usage patterns for optimization, develop new features and improvements, troubleshoot technical issues, enhance user experience. 3.3 Communication: Send important system updates, provide account and security notifications, respond to support inquiries, share relevant product information. 3.4 Legal Compliance: Meet regulatory requirements, protect against fraud and abuse, ensure system security and integrity, comply with legal obligations."
        },
        protection: {
        ...
        contact: {
          title: "12. Contact Us",
          content: "For privacy-related questions or concerns: Data Protection Officer: Email: mamak@kadaipos.id, Phone: +6281339765775. Mailing Address: Business Hours: Monday - Friday: 09:00 - 18:00 WIB, Saturday: 09:00 - 13:00 WIB, Sunday & Holidays: Closed. We will respond to your inquiry within 7 business days."
        }
      }
    },
    terms: {
      ...
      sections: {
        intro: {
          title: "1. Introduction",
          content: "Welcome to Kadai (Point of Sale System). These Terms and Conditions govern your use of the Kadai application for restaurant management, including ordering, payments, and daily operations. By using this application, you agree to be bound by the following terms and conditions."
        },
        definitions: {
          title: "2. Definitions",
          content: "\"Application\" refers to Kadai, including all its features and services. \"User\" is restaurant staff using the application (cashier, waiter, chef, admin). \"Admin\" is the restaurant manager with full system access. \"Services\" include all functions provided by the application. \"Data\" includes all information entered or processed through the application."
        },
        access: {
        ...
        usage: {
          title: "4. Usage Terms",
          content: "4.1 Permitted Use: Process customer orders accurately, Manage menu, tables, and inventory as authorized, View reports and analytics according to access rights, Use internal communication features for team coordination. 4.2 Prohibited Use: Manipulate transaction data or financial reports, Use system for personal transactions unrelated to business, Share login access with unauthorized parties, Use application for illegal purposes or violate laws, Damage, disrupt, or exploit the system, Access data beyond your permissions. 4.3 User Responsibilities: Ensure accuracy of entered data, Report bugs or system errors immediately, Maintain devices used in good condition, Follow restaurant standard operating procedures."
        },
        payment: {
          title: "6. Transactions & Payments",
          content: "6.1 Payment Methods: KadaiPOS supports various methods: Cash, Debit/Credit Cards, Bank Transfer, E-wallets (GoPay, OVO, Dana, ShopeePay), QRIS. 6.2 Transaction Responsibilities: Users must verify order details before confirmation, All transactions are recorded and cannot be modified without authorization, Cancellations or refunds must follow established procedures, Cashiers are responsible for payment accuracy. 6.3 Payment Security: Credit card data is not stored in our system, Digital payments processed through secure gateways, Digital receipts sent automatically after payment, Users must report payment discrepancies immediately."
        },
        liability: {
        ...
        compliance: {
          ...
          content: "8.1 Taxation: Restaurants must comply with Indonesian tax regulations, System provides reports for tax purposes, Restaurants are responsible for timely tax payments. 8.2 Licensing: Restaurants must have valid business licenses, Application only for legal and legitimate operations, We reserve the right to terminate service if used illegally. 8.3 Consumer Protection: Restaurants must comply with Consumer Protection Law, Menu prices must be clear and accurate, Allergen and ingredient information must be available. 8.4 Employment: Admin responsible for employment law compliance, Work schedules and staff compensation per Labor Law."
        },
        ip: {
        ...
        contact: {
          ...
          content: "For questions about these Terms and Conditions: Email: mamak@kadaipos.id, Phone: +6281339765775, Address: , Business Hours: Monday - Friday: 09:00 - 18:00 WIB, Saturday: 09:00 - 13:00 WIB, Sunday & Holidays: Closed."
        }
      }
    },
    cookies: {
      ...
      summaryContent: "We use cookies to make KadaiPOS work properly (essential), understand how you use it (analytics), remember your preferences (functional), and show you relevant content (marketing). You can control non-essential cookies in your settings.",
      relatedDocuments: "Related Documents:",
      privacyPolicy: "Privacy Policy",
      ...
      sections: {
        ...
        manage: {
          ...
          content: "You have several options to manage cookies: 7.1 Browser Settings: Most browsers allow you to view and delete cookies, block all cookies, block third-party cookies, set preferences for specific websites. Browser-specific instructions: Chrome: Settings > Privacy and security > Cookies, Firefox: Settings > Privacy & Security > Cookies, Safari: Preferences > Privacy > Cookies, Edge: Settings > Cookies and site permissions. 7.2 App Settings: In KadaiPOS, go to Settings > Privacy > Cookie Preferences. Toggle on/off: Performance cookies, Functional cookies, Marketing cookies. 7.3 Opt-Out Tools: Google Analytics: tools.google.com/dlpage/gaoptout, Network Advertising Initiative: optout.networkadvertising.org, Digital Advertising Alliance: optout.aboutads.info. 7.4 Important Notes: Disabling essential cookies will prevent you from using KadaiPOS, Some features may not work properly without functional cookies, Your preferences are stored in a cookie, so clearing all cookies will reset your choices."
        },
        updates: {
...
We will respond to your inquiry within 7 business days.`
    ...
    demo: {
      ...
      titleHighlight: "Kadai",
      subtitle: "Live Demo",
      description: "We're preparing an amazing interactive demo experience for you. Leave your WhatsApp number and we'll notify you when it's ready!",
  ...
  id: {
    nav: {
      ...
      businessMenu: {
        ...
        subtitle: "Sistem POS yang sempurna untuk setiap jenis bisnis",
        tokoTitle: "Kadai Toko",
        tokoDesc: "POS Sederhana untuk Bisnis Kecil",
        restoTitle: "Kadai Resto",
        restoDesc: "Manajemen Restoran Lengkap",
        compare: "Bandingkan Kedua Solusi"
      },
    },
    hero: {
    ...
    cta: {
      ...
      futureOfRestaurant: "Rasakan masa depan manajemen restoran dengan Kadai",
    ...
    contact: {
      badge: "FORM KONTAK SEGERA HADIR",
      title: "Hubungi",
      titleHighlight: "Kami",
      subtitle: "Kami sedang membangun form kontak yang indah untuk Anda. Sementara itu, hubungi kami langsung via WhatsApp, email, atau telepon!",
      whatsappPlaceholder: "Nomor WhatsApp (contoh: 628123456789)",
      ...
      contactMethods: {
        ...
        phone: {
          title: "Telepon",
          description: "Telepon kami saat jam kerja"
        }
      },
      visitUs: {
        title: "Kunjungi Kami",
    ...
    pricing: {
      ...
      completeSolution: "Solusi POS lengkap untuk bisnis modern",
      tokoTagline: "POS Sederhana untuk retail & toko",
      tokoSuitable: "Retail, Butik, Minimarket",
      restoTagline: "Manajemen lengkap untuk kafe & restoran",
      restoSuitable: "Kafe, Restoran, Bar, Toko Roti",
      heroTitle: "Pilih Solusi",
      heroTitleHighlight: "Terbaik untuk Bisnis Anda",
      heroOr: "atau",
      heroToko: "Kadai Toko",
      heroResto: "Kadai Resto",
      ...
      tiersNote: "Omzet dihitung berdasarkan total transaksi bulanan yang diproses melalui KadaiPOS.",
      ...
      comparisonBox: "Bandingkan Kadai Toko vs Kadai Resto",
      tokoComparisonFeatures: [
        "Checkout retail cepat",
        "Pelacakan stok",
        "Laporan penjualan",
    ...
    privacy: {
      ...
      importantNotice: {
        ...
        content: "Harap baca Kebijakan Privasi ini dengan seksama. Dengan menggunakan KadaiPOS, Anda mengakui bahwa Anda telah membaca, memahami, dan setuju untuk terikat oleh kebijakan ini. Jika Anda tidak setuju, harap jangan gunakan layanan kami."
      },
      privacyCommitment: {
      ...
      sections: {
        ...
        children: {
          ...
          content: "KadaiPOS tidak dimaksudkan untuk digunakan oleh anak-anak di bawah usia 18 tahun. Kami tidak dengan sengaja mengumpulkan data dari anak di bawah umur. Pemilik restoran harus memastikan anggota staf berusia 18+. Jika kami menemukan data dari anak di bawah umur, kami akan menghapusnya. Orang tua/wali dapat menghubungi kami untuk menghapus data anak di bawah umur. Jika Anda yakin kami telah mengumpulkan informasi dari anak, segera hubungi kami di mamak@kadaipos.id"
        },
        international: {
        ...
        contact: {
          ...
          content: "Untuk pertanyaan atau masalah terkait privasi: Petugas Perlindungan Data: Email: mamak@kadaipos.id, Telepon: +6281339765775. Alamat Surat: Jam Operasional: Senin - Jumat: 09:00 - 18:00 WIB, Sabtu: 09:00 - 13:00 WIB, Minggu & Libur: Tutup. Kami akan menanggapi pertanyaan Anda dalam 7 hari kerja."
        }
      }
    },
    terms: {
      ...
      sections: {
        ...
        contact: {
          ...
          content: "Untuk pertanyaan tentang Syarat dan Ketentuan ini: Email: mamak@kadaipos.id, Telepon: +6281339765775, Alamat: , Jam Operasional: Senin - Jumat: 09:00 - 18:00 WIB, Sabtu: 09:00 - 13:00 WIB, Minggu & Libur: Tutup."
        }
      }
    },
    cookies: {
      ...
      summaryContent: "Kami menggunakan cookie untuk membuat KadaiPOS berfungsi dengan baik (esensial), memahami bagaimana Anda menggunakannya (analitik), mengingat preferensi Anda (fungsional), dan menampilkan konten yang relevan (pemasaran). Anda dapat mengontrol cookie non-esensial di pengaturan Anda.",
      relatedDocuments: "Dokumen Terkait:",
      privacyPolicy: "Kebijakan Privasi",
      ...
      sections: {
        ...
        performance: {
          ...
          content: "Cookie ini membantu kami memahami bagaimana Anda berinteraksi dengan KadaiPOS sehingga kami dapat meningkatkan layanan kami. Cookie Analitik: Tampilan halaman dan pola navigasi, statistik penggunaan fitur, waktu yang dihabiskan di bagian berbeda, analisis alur pengguna, pelacakan dan pelaporan error."
        },
        functional: {
        ...
        manage: {
          ...
          content: "Anda memiliki beberapa opsi untuk mengelola cookie: 7.1 Pengaturan Browser: Sebagian besar browser memungkinkan Anda untuk melihat dan menghapus cookie, blokir semua cookie, blokir cookie pihak ketiga, mengatur preferensi untuk situs web tertentu. Instruksi spesifik browser: Chrome: Settings > Privacy and security > Cookies, Firefox: Settings > Privacy & Security > Cookies, Safari: Preferences > Privacy > Cookies, Edge: Settings > Cookies and site permissions. 7.2 Pengaturan Aplikasi: Di KadaiPOS, buka Settings > Privacy > Cookie Preferences. Toggle on/off: Cookie kinerja, Cookie fungsional, Cookie pemasaran. 7.3 Alat Opt-Out: Google Analytics: tools.google.com/dlpage/gaoptout, Network Advertising Initiative: optout.networkadvertising.org, Digital Advertising Alliance: optout.aboutads.info. 7.4 Catatan Penting: Menonaktifkan cookie esensial akan mencegah Anda menggunakan KadaiPOS, Beberapa fitur mungkin tidak berfungsi dengan baik tanpa cookie fungsional, Preferensi Anda disimpan dalam cookie, jadi menghapus semua cookie akan mereset pilihan Anda."
        },
        updates: {
...
Kami akan menanggapi pertanyaan Anda dalam 7 hari kerja.`
    ...
    demo: {
      ...
      title: "Rasakan",
      titleHighlight: "Kadai",
      subtitle: "Demo Langsung",
      description: "Kami sedang mempersiapkan pengalaman demo interaktif yang luar biasa untuk Anda. Tinggalkan nomor WhatsApp Anda dan kami akan memberitahu Anda saat sudah siap!",
  ...
  zh: {
    nav: {
      ...
      businessMenu: {
        title: "选择您的解决方案",
        subtitle: "适用于每种业务类型的完美 POS 系统",
        tokoTitle: "Kadai Toko",
        tokoDesc: "适用于小型企业的简单 POS",
        restoTitle: "Kadai Resto",
        restoDesc: "完整的餐厅管理",
        compare: "比较两种解决方案"
      },
    ...
    hero: {
      ...
      title: "使用以下方式提升您的业务",
      titleHighlight: "智能收银系统",
      subtitle: "Kadai 是专为餐厅、咖啡馆和零售店设计的一体化收银解决方案。提高效率、满足客户需求并拓展您的业务。",
      realUi: "直接查看真实界面。不是空白的 mockup，每个组件都展示我们移动应用的真实 UI、数据和交互。",
      getStarted: "立即开始",
      watchDemo: "观看演示",
      badge: "最佳 POS 系统",
      heading: "优势之上的优势。",
      tagline: "适用于餐厅、咖啡馆和零售店的完整 POS 系统。使用我们的现代解决方案简化运营并满足客户。",
      learnMore: "了解更多",
      realtimeSync: "实时同步",
      secure: "100% 安全",
      support24x7: "24/7 支持",
    ...
    cta: {
      ...
      yourBusiness: "您的业务？",
      futureOfRestaurant: "使用 Kadai 体验餐厅管理的未来",
    ...
    contact: {
      ...
      title: "联系",
      titleHighlight: "我们",
      subtitle: "我们正在为您构建一个漂亮的联系表单。同时，请通过WhatsApp、电子邮件或电话直接联系我们！",
      whatsappPlaceholder: "WhatsApp号码（例如：628123456789）",
      contactMe: "联系我",
      registered: "已注册！",
    ...
    about: {
      ...
      title: "变革",
      titleHighlight: "业务管理",
      subtitle: "Kadai是一个新的现代销售点系统，专为所有类型的印尼企业设计 - 从餐厅和咖啡馆到零售店。我们正在构建一个强大而直观的平台，帮助企业主高效管理运营，并专注于最重要的事情 - 为客户服务。",
      stats: {
        founded: "成立",
        cloudBased: "基于云端",
        coreFeatures: "核心功能",
    ...
    pricing: {
      ...
      tiersNote: "收入是根据通过 KadaiPOS 处理的每月总交易额计算的。",
      ...
      comparisonBox: "比较 Kadai Toko 与 Kadai Resto",
      tokoComparisonFeatures: [
        "快速零售结账",
        "库存跟踪",
        "销售报告",
    ...
    privacy: {
      ...
      importantNotice: {
        title: "重要通知",
        content: "请仔细阅读本隐私政策。通过使用 KadaiPOS，您承认您已阅读、理解并同意受本政策约束。如果您不同意，请不要使用我们的服务。"
      },
      privacyCommitment: {
        title: "隐私承诺",
      ...
      sections: {
        ...
        children: {
          title: "9. 儿童隐私",
          content: "KadaiPOS不适用于18岁以下儿童使用。我们不会故意从未成年人收集数据。餐厅所有者必须确保员工年满18岁。如果我们发现未成年人的数据，我们将删除它。父母/监护人可以联系我们删除未成年人的数据。如果您认为我们收集了儿童的信息，请立即通过mamak@kadaipos.id联系我们"
        },
        international: {
          title: "10. 国际数据传输",
        ...
        contact: {
          title: "12. 联系我们",
          content: "有关隐私相关问题或疑虑：数据保护官：电子邮件：mamak@kadaipos.id，电话：+6281339765775。邮寄地址：营业时间：周一至周五：09:00 - 18:00 WIB，周六：09:00 - 13:00 WIB，周日和节假日：关闭。我们将在7个工作日内回复您的查询。"
        }
      }
    },
    terms: {
      ...
      sections: {
        ...
        payment: {
          title: "6. 交易与付款",
          content: "6.1 付款方式：KadaiPOS 支持各种方式：现金，借记卡/信用卡，银行转账，电子钱包 (GoPay, OVO, Dana, ShopeePay)，QRIS。6.2 交易责任：用户必须在确认前验证订单详情，所有交易都被记录且未经授权不能修改，取消或退款必须遵循既定程序，出纳员对付款准确性负责。6.3 付款安全：信用卡数据不会存储在我们的系统中，数字付款通过安全网关处理，付款后自动发送数字收据，用户必须立即报告付款差异。"
        },
        liability: {
          title: "7. 责任限制",
        ...
        contact: {
          title: "13. 联系信息",
          content: "有关这些条款和条件的问题：电子邮件：mamak@kadaipos.id，电话：+6281339765775，地址：，营业时间：周一至周五：09:00-18:00 WIB，周六：09:00-13:00 WIB，周日和节假日：关闭。"
        }
      }
    },
    cookies: {
      ...
      summaryContent: "我们使用 Cookie 来使 KadaiPOS 正常工作（必需）、了解您如何使用它（分析）、记住您的偏好（功能）和向您显示相关内容（营销）。您可以在设置中控制非必需 Cookie。",
      relatedDocuments: "相关文档：",
      privacyPolicy: "隐私政策",
      ...
      sections: {
        ...
        performance: {
          title: "3. 性能 Cookie",
          content: "这些 Cookie 帮助我们了解您如何与 KadaiPOS 互动，以便我们改进服务。分析 Cookie：页面浏览和导航模式、功能使用统计、不同部分的时间、用户流程分析、错误跟踪和报告。"
        },
        functional: {
          title: "4. 功能 Cookie",
        ...
        manage: {
          ...
          content: "您有几个选项来管理 Cookie：7.1 浏览器设置：大多数浏览器允许您查看和删除 Cookie、阻止所有 Cookie、阻止第三方 Cookie、为特定网站设置偏好。浏览器特定说明：Chrome: Settings > Privacy and security > Cookies，Firefox: Settings > Privacy & Security > Cookies，Safari: Preferences > Privacy > Cookies，Edge: Settings > Cookies and site permissions。7.2 应用程序设置：在 KadaiPOS 中，转到 Settings > Privacy > Cookie Preferences。切换开/关：性能 Cookie、功能 Cookie、营销 Cookie。7.3 选择退出工具：Google Analytics: tools.google.com/dlpage/gaoptout，Network Advertising Initiative: optout.networkadvertising.org，Digital Advertising Alliance: optout.aboutads.info。7.4 重要说明：禁用基本 Cookie 将阻止您使用 KadaiPOS，一些功能在没有功能 Cookie 的情况下可能无法正常工作，您的偏好存储在 Cookie 中，因此清除所有 Cookie 将重置您的选择。"
        },
        updates: {
          title: "8. 本政策的更新",
...
我们将在 7 个工作日内回复您的咨询。`
    ...
    demo: {
      ...
      titleHighlight: "Kadai",
      subtitle: "现场演示",
      description: "我们正在为您准备精彩的互动演示体验。请留下您的WhatsApp号码，我们会在准备就绪时通知您！",
    ...
    mockups: {
      ...
      tables: {
        ...
        forLargeGroups: "For large groups",
      ...
      inventory: {
        ...
        itemsLowStock: "items low on stock",
        itemLowStock: "item low on stock",
        current: "Current",
        minimum: "Min",
      ...
      menu: {
        ...
        addEditMenuItem: "Add/Edit Menu Item",
        ...
        beverages: "Beverages",
        minumanBeralkohol: "Minuman Beralkohol",
      ...
      orders: {
        ...
        specialFriedRice: "Special fried rice",
        nasiGorengBiasa: "Nasi Goreng Biasa",
        regularFriedRice: "Regular fried rice",
        ...
        biayaPelayanan: "Biaya Pelayanan",
        total: "Total",
        totalAmount: "Total",
        addItem: "Add Item",
      ...
      payment: {
        ...
        pembayaranCheckout: "Pembayaran Checkout",
        ...
        scanQRBayar: "Scan kode QR untuk bayar",
      ...
      qr: {
        ...
        restaurantName: "Restaurant Name",
        namaRestoran: "Nama Restoran",
        scanToOrder: "Scan to order food",
        scanUntukPesan: "Scan untuk pesan makanan",
      ...
      // Theme Mockups
      theme: {
        interactiveTheme: "Interactive Theme",
        temaInteraktif: "Tema Interaktif",
        selectYourTheme: "Select your theme",
        pilihTemaAnda: "Pilih tema Anda",
        kadaiRed: "Kadai Red",
